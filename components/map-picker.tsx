...
export default function MapPicker({
    ...
    useEffect(() => {
        ...
        if (!apiKey) {
            ...
            console.warn(
                "Missing NEXT_PUBLIC_GOOGLE_MAPS_API_KEY; MapPicker will not load Google Maps"
            );
            return;
        }
        ...
        function init() {
            ...
            if (value.lat === null || value.lng === null) {
                console.log(
                    "MapPicker: No location provided, showing default map view"
                );
                // Don't auto-detect, just show default location
                initWithDefaultLocation();
            } else {
                console.log(
                    "MapPicker: Using provided location:",
                    value.lat,
                    value.lng
                );
                    ...
                    {showMyLocationButton && (
                        <button
                            ...
                            onClick={async () => {
                                ...
                                console.log(
                                    "Trying Google Geolocation API first..."
                                );
                                ...
                                console.log(
                                    "Google API failed or returned inaccurate location, trying browser GPS..."
                                );
                                console.log(
                                    "=== BROWSER GPS REQUEST (HIGH ACCURACY) ==="
                                );
                                navigator.geolocation.getCurrentPosition(
                                    (pos) => {
                                        console.log(
                                            "Raw geolocation response:",
                                            {
