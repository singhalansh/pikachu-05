          ...
          geocoderRef.current.geocode({ location: { lat, lng } }, (results: any, status: any) => {
            if (status === "OK" && results && results[0]) {
              ...
              if (placesServiceRef.current && results[0].place_id) {
                placesServiceRef.current.getDetails({ placeId: results[0].place_id }, (place: any, plStatus: any) => {
          ...
          {showMyLocationButton && (
            <button
              ...
              onClick={async () => {
                ...
                console.log('Google API failed, falling back to browser geolocation...');
