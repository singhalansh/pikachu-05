...
const availableReports = [
    {
        ...
        description:
            "Comprehensive overview of all issues reported and resolved in the selected month",
        type: "summary",
    ...
    },
    {
        ...
        description:
            "Analysis of each department's efficiency and resolution rates",
        type: "performance",
    ...
    },
    {
        ...
        description:
            "Historical trends and predictive insights for issue patterns",
        type: "trends",
...
export default function AdminReportsPage() {
    ...
    const handleGenerateReport = async () => {
        ...
        console.log(
            `Generating ${selectedReport} report in ${reportFormat} format`
        );
    };
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <Card className="shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-emerald-50/30">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Create custom reports with specific
                            ...
                            <div>
                                <Card className="shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-green-50/30">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Previously generated reports ready
                                            for download
                                        </CardDescription>
                                    </CardHeader>
