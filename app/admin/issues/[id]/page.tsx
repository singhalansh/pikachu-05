      ...
      <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {issue.estimated_completion && (
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {new Date(issue.estimated_completion).toLocaleDateString()}
                    </p>
                  </div>
                )}
                ...
                {issue.completed_at && (
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {new Date(issue.completed_at).toLocaleDateString()} at{' '}
                      {new Date(issue.completed_at).toLocaleTimeString()}
                    </p>
        ...
        <div className="space-y-6">
          <AdminDepartmentAssigner
            ...
            currentDepartment={issue.department ? {
