...
function UnifiedAuthPageInner() {
    ...
    useEffect(() => {
        ...
        if (
            roleParam &&
            (roleParam === "citizen" ||
                roleParam === "department_head" ||
                roleParam === "supervisor" ||
                roleParam === "field_worker" ||
                roleParam === "clerk_operator" ||
                    ...
                    <CardContent className="space-y-6">
                        ...
                        {authMode === "signup" && (
                            <p className="text-xs text-muted-foreground text-center mt-2">
                                Make sure to select your role above before using
                                Google signup
                            </p>
                        )}
