    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2E6A56] to-[#5C9479] flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="mt-2 text-white/80">Please wait while we check your authentication status.</p>
        </div>
      </div>
    )
  }
          ...
          <Card className="backdrop-blur-xl bg-white/95 shadow-2xl border-0 overflow-hidden">
            ...
            <CardContent className="space-y-6 px-8 pb-8">
              ...
              {authMode === "signup" && selectedRole !== "citizen" && (
                <div className="space-y-2">
                  <Label htmlFor="department" className="text-gray-700 font-semibold">Select Your Department</Label>
              ...
              <div className="text-center text-sm">
                ...
                <Button variant="link" className="p-0 h-auto text-[#2E6A56] hover:text-[#5C9479] font-semibold hover:underline" onClick={toggleAuthMode}>
